...
if (isset($_POST['update'])) {
  ...
  // Getting the personal information
    ...
    $authorID = $con->updateAuthors($author_FN, $author_LN,$author_birthday, $author_nat,$author_id);
    ...
    if ($authorID) {
        ...
        $sweetAlertConfig = "
            <script>
                Swal.fire({
                    ...
                    text: 'You have successfully updated the Author!',
        ...
        $_SESSION['error'] = "Sorry, there was an error in updating.";
    }
}
?>
...
<div class="container my-5 border border-2 rounded-3 shadow p-4 bg-light">
  ...
  <form method="POST" action="">
    ...
    <div class="mb-3">
      ...
      <input type="text" value="<?php echo $data['author_LN']?>" class="form-control" id="author_LN" name="author_LN" required>
    </div>
    <div class="mb-3">
      <label for="authorBirthYear" class="form-label">Birth Date</label>
      <input type="date" 
        value="<?php echo isset($data['author_birthday']) ? date('Y-m-d', strtotime($data['author_birthday'])) : ''; ?>" required>
    </div>
    <div class="mb-3">
